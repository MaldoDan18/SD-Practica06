...
# Coordinator HTTP client removed for simplified deployment.
...
class SaleHTTPRequestHandler(BaseHTTPRequestHandler):
	...
	def _maybe_activate_global_start(self) -> None:
		# Coordinator removed: start sales locally when all clients are ready
...
def main() -> None:
	...
	server = SaleHTTPServer((args.host, args.port), SaleHTTPRequestHandler, sale_state, ticketing_client)
	...
	# Coordinator integration removed.
