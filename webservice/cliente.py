...
def notify_coordinator(coordinator_url: str | None, path: str, payload: dict[str, Any]) -> None:
    # Coordinator integration removed for deployment.
    return
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--sale-id", default="venta-web", help="Identificador de venta")
...
def main() -> None:
    ...
    # Coordinator integration removed — no final notification.
